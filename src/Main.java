...
public class Main {
    public static void main(String[] args) {
        ...
        Job job = jobController.createJob("Designer", "Imagem e Vídeo", 17534, "Híbrido", 6, "Figma, Canva, Edição de vídeos");
        ...
        Job job2 = jobController.createJob("Engenheiro de Software A3", "TI", 18785, "Híbrido", 8, "Linux");
        ...
        Job job3 = jobController.createJob("Fogueteiro", "Projetista", 26988, "Presencial", 10, "Catia");
        ...
        Job job4 = jobController.createJob("Vendedor","Comécio", 2466, "Presencial", 12, "Experiência com vendas");
